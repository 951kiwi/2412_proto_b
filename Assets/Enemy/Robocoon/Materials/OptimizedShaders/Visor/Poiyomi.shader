Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/3545d30187664bd4ba5488c1beca3c26"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				float3 directColor = _LightColor0.rgb * saturate(RTWrapFunc(poiLight.nDotL, (0.0 /*_LightingWrappedWrap*/), (0.0 /*_LightingWrappedNormalization*/))) * lerp(1, poiLight.attenuation, poiLight.attenuationStrength);
				float3 indirectColor = ShadeSH9_wrapped(poiMesh.normals[(0.0 /*_LightingIndirectUsesNormals*/)], (0.0 /*_LightingWrappedWrap*/)) * poiLight.occlusion;
				...
				poiLight.rampedLightMap = saturate((poiLight.lightMap - (1 - (0.5 /*_LightingGradientEnd*/))) / saturate((1 - (0.0 /*_LightingGradientStart*/)) - (1 - (0.5 /*_LightingGradientEnd*/)) + fwidth(poiLight.lightMap)));
				float3 mathRamp = lerp(float3(1, 1, 1), saturate(lerp((float4(1,1,1,1) * lerp(indirectColor, 1, (1.0 /*_LightingIgnoreAmbientColor*/))), float3(1, 1, 1), saturate(poiLight.rampedLightMap))), (1.0 /*_ShadowStrength*/));
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = (0.02 /*_EmissionStrength*/);
				...
				if ((1.0 /*_EmissionBlinkingEnabled*/))
				{
					emissionStrength0 *= calculateBlinkingEmission((0.95 /*_EmissiveBlink_Min*/), (1.0 /*_EmissiveBlink_Max*/), (60.0 /*_EmissiveBlink_Velocity*/), (0.0 /*_EmissionBlinkingOffset*/));
				}
				...
				#if defined(PROP_EMISSIONMASK) || !defined(OPTIMIZER_ENABLED)
				float emissionMask0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMaskUV*/)], float4(1,1,-0.02,0)) + _Time.x * float4(0,0,0,0))[(0.0 /*_EmissionMaskChannel*/)];
				#else
				...
				{
					emissionMask0 = customBlend(emissionMask0, poiMods.globalMask[(0.0 /*_EmissionMask0GlobalMask*/)-1], (0.0 /*_EmissionMask0GlobalMaskBlendType*/));
				}
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float metallic = (0.762 /*_MochieMetallicMultiplier*/);
				...
				#endif
				reflectionMask *= (0.502 /*_MochieReflectionStrength*/);
				specularMask *= (0.559 /*_MochieSpecularStrength*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.occlusion = min(min(min(lerp(1, AOMaps.r, (0.5 /*_LightDataAOStrengthR*/)), lerp(1, AOMaps.g, (0.0 /*_LightDataAOStrengthG*/))), lerp(1, AOMaps.b, (0.0 /*_LightDataAOStrengthB*/))),lerp(1, AOMaps.a, (0.0 /*_LightDataAOStrengthA*/)));
				#else
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.2176419,0.2245845,0.3572768,0.8235294).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.2176419,0.2245845,0.3572768,0.8235294).a;
				...
				clip(poiFragData.alpha - (0.608 /*_Cutoff*/));
